...
def init_ff(phase,level='frame',n_frames=8):
	...
	root_folder = '/home/csgrad/yzhai6/Projects/SelfBlendedImages/'

	dataset_path=root_folder+'data/FaceForensics++/original_sequences/youtube/c23/frames/'
	...
	filelist = []
	list_dict = json.load(open(root_folder + f'data/FaceForensics++/{phase}.json','r'))
	for i in list_dict:
		filelist+=i
